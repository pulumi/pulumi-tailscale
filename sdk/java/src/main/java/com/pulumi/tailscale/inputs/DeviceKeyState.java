...
public final class DeviceKeyState extends com.pulumi.resources.ResourceArgs {

    public static final DeviceKeyState Empty = new DeviceKeyState();
    ...
    private DeviceKeyState() {}

    private DeviceKeyState(DeviceKeyState $) {
    ...
    public static Builder builder(DeviceKeyState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DeviceKeyState defaults) {
            $ = new DeviceKeyState(Objects.requireNonNull(defaults));
        }
