...
public final class DnsConfigurationState extends com.pulumi.resources.ResourceArgs {

    public static final DnsConfigurationState Empty = new DnsConfigurationState();
    ...
    private DnsConfigurationState() {}

    private DnsConfigurationState(DnsConfigurationState $) {
    ...
    public static Builder builder(DnsConfigurationState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DnsConfigurationState();
        }

        public Builder(DnsConfigurationState defaults) {
            $ = new DnsConfigurationState(Objects.requireNonNull(defaults));
        }
        ...
        public DnsConfigurationState build() {
            return $;
        }
    }
