...
@CustomType
public final class DnsConfigurationSplitDnNameserver {
    /**
    ...
    public static Builder builder(DnsConfigurationSplitDnNameserver defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean useWithExitNode;
        public Builder() {}
        public Builder(DnsConfigurationSplitDnNameserver defaults) {
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("DnsConfigurationSplitDnNameserver", "address");
            }
        ...
        public DnsConfigurationSplitDnNameserver build() {
            final var _resultValue = new DnsConfigurationSplitDnNameserver();
