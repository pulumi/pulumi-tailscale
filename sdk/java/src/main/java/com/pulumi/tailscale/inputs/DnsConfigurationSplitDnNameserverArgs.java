...
public final class DnsConfigurationSplitDnNameserverArgs extends com.pulumi.resources.ResourceArgs {

    public static final DnsConfigurationSplitDnNameserverArgs Empty = new DnsConfigurationSplitDnNameserverArgs();
    ...
    private DnsConfigurationSplitDnNameserverArgs() {}

    private DnsConfigurationSplitDnNameserverArgs(DnsConfigurationSplitDnNameserverArgs $) {
    ...
    public static Builder builder(DnsConfigurationSplitDnNameserverArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DnsConfigurationSplitDnNameserverArgs();
        }

        public Builder(DnsConfigurationSplitDnNameserverArgs defaults) {
            $ = new DnsConfigurationSplitDnNameserverArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DnsConfigurationSplitDnNameserverArgs build() {
            if ($.address == null) {
                throw new MissingRequiredPropertyException("DnsConfigurationSplitDnNameserverArgs", "address");
            }
            return $;
        }
    }
