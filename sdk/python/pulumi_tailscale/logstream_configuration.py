...
class LogstreamConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] s3_region: The region in which the S3 bucket is located. Required if destination_type is 's3'.
        :param pulumi.Input[_builtins.str] s3_role_arn: ARN of the AWS IAM role that Tailscale should assume when using role-based authentication. Required if destination*type is 's3' and s3*authentication_type is 'rolearn'.
        :param pulumi.Input[_builtins.str] s3_secret_access_key: The S3 secret access key. Required if destination*type is 's3' and s3*authentication_type is 'accesskey'.
        :param pulumi.Input[_builtins.str] token: The token/password with which log streams to this endpoint should be authenticated, required unless destination_type is 's3'.
        :param pulumi.Input[_builtins.int] upload_period_minutes: An optional number of minutes to wait in between uploading new logs. If the quantity of logs does not fit within a single upload, multiple uploads will be made.
        :param pulumi.Input[_builtins.str] url: The URL to which log streams are being posted. If destination_type is 's3' and you want to use the official Amazon S3 endpoint, leave this empty.
        :param pulumi.Input[_builtins.str] user: The username with which log streams to this endpoint are authenticated. Only required if destination_type is 'elastic', defaults to 'user' if not set.
        """
...
class LogstreamConfiguration(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="s3SecretAccessKey")
    def s3_secret_access_key(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The S3 secret access key. Required if destination*type is 's3' and s3*authentication_type is 'accesskey'.
        """
        return pulumi.get(self, "s3_secret_access_key")
