...
class WebhookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] endpoint_url: The endpoint to send webhook events to.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subscriptions: The Tailscale events to subscribe this webhook to. See https://tailscale.com/kb/1213/webhooks#events for the list of valid events.
        :param pulumi.Input[builtins.str] provider_type: The provider type of the endpoint URL. Also referred to as the 'destination' for the webhook in the admin panel. Webhook event payloads are formatted according to the provider type if it is set to a known value. Must be one of `slack`, `mattermost`, `googlechat`, or `discord` if set.
        """
...
class _WebhookState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] endpoint_url: The endpoint to send webhook events to.
        :param pulumi.Input[builtins.str] provider_type: The provider type of the endpoint URL. Also referred to as the 'destination' for the webhook in the admin panel. Webhook event payloads are formatted according to the provider type if it is set to a known value. Must be one of `slack`, `mattermost`, `googlechat`, or `discord` if set.
        :param pulumi.Input[builtins.str] secret: The secret used for signing webhook payloads. Only set on resource creation. See https://tailscale.com/kb/1213/webhooks#webhook-secret for more information.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subscriptions: The Tailscale events to subscribe this webhook to. See https://tailscale.com/kb/1213/webhooks#events for the list of valid events.
        """
...
class Webhook(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            provider_type: Optional[pulumi.Input[builtins.str]] = None,
            secret: Optional[pulumi.Input[builtins.str]] = None,
            subscriptions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Webhook':
        """
