...
class AclArgs:
    def __init__(__self__, *,
                 acl: pulumi.Input[builtins.str],
                 overwrite_existing_content: Optional[pulumi.Input[builtins.bool]] = None,
                 reset_acl_on_destroy: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a Acl resource.
        :param pulumi.Input[builtins.str] acl: The policy that defines which devices and users are allowed to connect in your network. Can be either a JSON or a HuJSON string.
        :param pulumi.Input[builtins.bool] overwrite_existing_content: If true, will skip requirement to import acl before allowing changes. Be careful, can cause ACL to be overwritten
        :param pulumi.Input[builtins.bool] reset_acl_on_destroy: If true, will reset the ACL for the Tailnet to the default when this resource is destroyed
        """
    ...
    @property
    @pulumi.getter
    def acl(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @acl.setter
    def acl(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "acl", value)

    @property
    @pulumi.getter(name="overwriteExistingContent")
    def overwrite_existing_content(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def overwrite_existing_content(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "overwrite_existing_content", value)

    @property
    @pulumi.getter(name="resetAclOnDestroy")
    def reset_acl_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def reset_acl_on_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Acl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            acl: Optional[pulumi.Input[builtins.str]] = None,
            overwrite_existing_content: Optional[pulumi.Input[builtins.bool]] = None,
            reset_acl_on_destroy: Optional[pulumi.Input[builtins.bool]] = None) -> 'Acl':
        """
    ...
    @property
    @pulumi.getter(name="overwriteExistingContent")
    def overwrite_existing_content(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, will skip requirement to import acl before allowing changes. Be careful, can cause ACL to be overwritten
        """
        return pulumi.get(self, "overwrite_existing_content")
    ...
    @property
    @pulumi.getter(name="resetAclOnDestroy")
    def reset_acl_on_destroy(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, will reset the ACL for the Tailnet to the default when this resource is destroyed
        """
        return pulumi.get(self, "reset_acl_on_destroy")
