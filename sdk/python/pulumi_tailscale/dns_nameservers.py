...
class DnsNameserversArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] nameservers: Devices on your network will use these nameservers to resolve DNS names. IPv4 or IPv6 
...
class DnsNameservers(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            nameservers: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'DnsNameservers':
        """
