...
class _AwsExternalIdState:
    def __init__(__self__, *,
                 ...
                 tailscale_aws_account_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering AwsExternalId resources.
        :param pulumi.Input[builtins.str] external_id: The External ID that Tailscale will supply when assuming your role. You must reference this in your IAM role's trust policy. See https://docs.aws.amazon.com/IAM/latest/UserGuide/id*roles*common-scenarios_third-party.html for more information on external IDs.
        :param pulumi.Input[builtins.str] tailscale_aws_account_id: The AWS account from which Tailscale will assume your role. You must reference this in your IAM role's trust policy. See https://docs.aws.amazon.com/IAM/latest/UserGuide/id*roles*common-scenarios_third-party.html for more information on external IDs.
        """
    ...
    def tailscale_aws_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def tailscale_aws_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "tailscale_aws_account_id", value)


@pulumi.type_token("tailscale:index/awsExternalId:AwsExternalId")
class AwsExternalId(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            external_id: Optional[pulumi.Input[builtins.str]] = None,
            tailscale_aws_account_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AwsExternalId':
        """
    ...
    @property
    @pulumi.getter(name="tailscaleAwsAccountId")
    def tailscale_aws_account_id(self) -> pulumi.Output[builtins.str]:
        """
        The AWS account from which Tailscale will assume your role. You must reference this in your IAM role's trust policy. See https://docs.aws.amazon.com/IAM/latest/UserGuide/id*roles*common-scenarios_third-party.html for more information on external IDs.
        """
        return pulumi.get(self, "tailscale_aws_account_id")
