...
class PostureIntegrationArgs:
    def __init__(__self__, *,
                 ...
                 posture_provider: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] client_secret: The secret (auth key, token, etc.) used to authenticate with the provider.
        :param pulumi.Input[builtins.str] posture_provider: The type of posture integration data provider.
        :param pulumi.Input[builtins.str] client_id: Unique identifier for your client.
        :param pulumi.Input[builtins.str] cloud_id: Identifies which of the provider's clouds to integrate with.
        :param pulumi.Input[builtins.str] tenant_id: The Microsoft Intune directory (tenant) ID. For other providers, this is left blank.
        """
    ...
    def posture_provider(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def posture_provider(self, value: pulumi.Input[builtins.str]):
...
class _PostureIntegrationState:
    def __init__(__self__, *,
                 ...
                 cloud_id: Optional[pulumi.Input[builtins.str]] = None,
                 posture_provider: Optional[pulumi.Input[builtins.str]] = None,
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="postureProvider")
    def posture_provider(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of posture integration data provider.
        """
        return pulumi.get(self, "posture_provider")
    ...
    @posture_provider.setter
    def posture_provider(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "posture_provider", value)
...
class PostureIntegration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            cloud_id: Optional[pulumi.Input[builtins.str]] = None,
            posture_provider: Optional[pulumi.Input[builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PostureIntegration':
        """
    ...
    @property
    @pulumi.getter(name="postureProvider")
    def posture_provider(self) -> pulumi.Output[builtins.str]:
        """
        The type of posture integration data provider.
        """
        return pulumi.get(self, "posture_provider")
