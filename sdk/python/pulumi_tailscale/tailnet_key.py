...
class TailnetKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] preauthorized: Determines whether or not the machines authenticated by the key will be authorized for the tailnet by default. Defaults to `false`.
        :param pulumi.Input[_builtins.str] recreate_if_invalid: Determines whether the key should be created again if it becomes invalid. By default, reusable keys will be recreated, but single-use keys will not. Possible values: 'always', 'never'.
        :param pulumi.Input[_builtins.bool] reusable: Indicates if the key is reusable or single-use. Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: List of tags to apply to the machines authenticated by the key.
        :param pulumi.Input[_builtins.str] user_id: ID of the user who created this key, empty for keys created by OAuth clients.
        """
...
class _TailnetKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: A description of the key consisting of alphanumeric characters. Defaults to `""`.
        :param pulumi.Input[_builtins.bool] ephemeral: Indicates if the key is ephemeral. Defaults to `false`.
        :param pulumi.Input[_builtins.str] expires_at: The expiry timestamp of the key in RFC3339 format
        :param pulumi.Input[_builtins.int] expiry: The expiry of the key in seconds. Defaults to `7776000` (90 days).
        :param pulumi.Input[_builtins.bool] invalid: Indicates whether the key is invalid (e.g. expired, revoked or has been deleted).
        :param pulumi.Input[_builtins.str] key: The authentication key
        :param pulumi.Input[_builtins.bool] preauthorized: Determines whether or not the machines authenticated by the key will be authorized for the tailnet by default. Defaults to `false`.
        :param pulumi.Input[_builtins.str] recreate_if_invalid: Determines whether the key should be created again if it becomes invalid. By default, reusable keys will be recreated, but single-use keys will not. Possible values: 'always', 'never'.
        :param pulumi.Input[_builtins.bool] reusable: Indicates if the key is reusable or single-use. Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: List of tags to apply to the machines authenticated by the key.
...
class TailnetKey(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="recreateIfInvalid")
    def recreate_if_invalid(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Determines whether the key should be created again if it becomes invalid. By default, reusable keys will be recreated, but single-use keys will not. Possible values: 'always', 'never'.
        """
        return pulumi.get(self, "recreate_if_invalid")
