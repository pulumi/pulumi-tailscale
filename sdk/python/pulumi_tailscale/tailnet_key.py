...
class TailnetKeyArgs:
    def __init__(__self__, *,
                 ...
                 preauthorized: Optional[pulumi.Input[builtins.bool]] = None,
                 recreate_if_invalid: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] ephemeral: Indicates if the key is ephemeral. Defaults to `false`.
        :param pulumi.Input[builtins.int] expiry: The expiry of the key in seconds. Defaults to `7776000` (90 days).
        :param pulumi.Input[builtins.bool] preauthorized: Determines whether or not the machines authenticated by the key will be authorized for the tailnet by default. Defaults to `false`.
        :param pulumi.Input[builtins.str] recreate_if_invalid: Determines whether the key should be created again if it becomes invalid. By default, reusable keys will be recreated, but single-use keys will not. Possible values: 'always', 'never'.
        :param pulumi.Input[builtins.bool] reusable: Indicates if the key is reusable or single-use. Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: List of tags to apply to the machines authenticated by the key.
        :param pulumi.Input[builtins.str] user_id: ID of the user who created this key, empty for keys created by OAuth clients.
        """
    ...
    @property
    @pulumi.getter
    def preauthorized(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def preauthorized(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "preauthorized", value)

    @property
    @pulumi.getter(name="recreateIfInvalid")
    def recreate_if_invalid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def recreate_if_invalid(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TailnetKeyState:
    def __init__(__self__, *,
                 ...
                 expiry: Optional[pulumi.Input[builtins.int]] = None,
                 invalid: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] description: A description of the key consisting of alphanumeric characters. Defaults to `""`.
        :param pulumi.Input[builtins.bool] ephemeral: Indicates if the key is ephemeral. Defaults to `false`.
        :param pulumi.Input[builtins.str] expires_at: The expiry timestamp of the key in RFC3339 format
        :param pulumi.Input[builtins.int] expiry: The expiry of the key in seconds. Defaults to `7776000` (90 days).
        :param pulumi.Input[builtins.bool] invalid: Indicates whether the key is invalid (e.g. expired, revoked or has been deleted).
        :param pulumi.Input[builtins.str] key: The authentication key
        :param pulumi.Input[builtins.bool] preauthorized: Determines whether or not the machines authenticated by the key will be authorized for the tailnet by default. Defaults to `false`.
        :param pulumi.Input[builtins.str] recreate_if_invalid: Determines whether the key should be created again if it becomes invalid. By default, reusable keys will be recreated, but single-use keys will not. Possible values: 'always', 'never'.
        :param pulumi.Input[builtins.bool] reusable: Indicates if the key is reusable or single-use. Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: List of tags to apply to the machines authenticated by the key.
    ...
    @property
    @pulumi.getter
    def invalid(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @invalid.setter
    def invalid(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class TailnetKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reusable: Optional[pulumi.Input[builtins.bool]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TailnetKey':
        """
    ...
    @property
    @pulumi.getter
    def invalid(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the key is invalid (e.g. expired, revoked or has been deleted).
        """
        return pulumi.get(self, "invalid")
    ...
    @property
    @pulumi.getter
    def preauthorized(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Determines whether or not the machines authenticated by the key will be authorized for the tailnet by default. Defaults to `false`.
        """
        return pulumi.get(self, "preauthorized")
    ...
    @property
    @pulumi.getter(name="recreateIfInvalid")
    def recreate_if_invalid(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Determines whether the key should be created again if it becomes invalid. By default, reusable keys will be recreated, but single-use keys will not. Possible values: 'always', 'never'.
        """
        return pulumi.get(self, "recreate_if_invalid")
    ...
    @property
    @pulumi.getter
    def reusable(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates if the key is reusable or single-use. Defaults to `false`.
        """
        return pulumi.get(self, "reusable")
