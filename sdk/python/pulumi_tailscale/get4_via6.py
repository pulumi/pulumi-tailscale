...
def get4_via6(cidr: Optional[_builtins.str] = None,
              site: Optional[_builtins.int] = None,
    ...
    :param _builtins.str cidr: The IPv4 CIDR to map
    :param _builtins.int site: Site ID (between 0 and 65535)
    """
    __args__ = dict()
    __args__['cidr'] = cidr
    __args__['site'] = site
