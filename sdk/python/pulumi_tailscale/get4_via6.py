...
def get4_via6(cidr: Optional[builtins.str] = None,
              site: Optional[builtins.int] = None,
    ...
    :param builtins.str cidr: The IPv4 CIDR to map
    :param builtins.int site: Site ID (between 0 and 65535)
    """
    __args__ = dict()
    __args__['cidr'] = cidr
    __args__['site'] = site
...
def get4_via6_output(cidr: Optional[pulumi.Input[builtins.str]] = None,
                     site: Optional[pulumi.Input[builtins.int]] = None,
