...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_key: The API key to use for authenticating requests to the API. Can be set via the TAILSCALE_API_KEY environment variable.
               Conflicts with 'oauth_client_id' and 'oauth_client_secret'.
        :param pulumi.Input[builtins.str] base_url: The base URL of the Tailscale API. Defaults to https://api.tailscale.com. Can be set via the TAILSCALE_BASE_URL
               environment variable.
        :param pulumi.Input[builtins.str] oauth_client_id: The OAuth application's ID when using OAuth client credentials. Can be set via the TAILSCALE_OAUTH_CLIENT_ID environment
               variable. Both 'oauth_client_id' and 'oauth_client_secret' must be set. Conflicts with 'api_key'.
        :param pulumi.Input[builtins.str] oauth_client_secret: The OAuth application's secret when using OAuth client credentials. Can be set via the TAILSCALE_OAUTH_CLIENT_SECRET
               environment variable. Both 'oauth_client_id' and 'oauth_client_secret' must be set. Conflicts with 'api_key'.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: The OAuth 2.0 scopes to request when for the access token generated using the supplied OAuth client credentials. See
        ...
        :param pulumi.Input[builtins.str] tailnet: The organization name of the Tailnet in which to perform actions. Can be set via the TAILSCALE_TAILNET environment
               variable. Default is the tailnet that owns API credentials passed to the provider.
        :param pulumi.Input[builtins.str] user_agent: User-Agent header for API requests.
        """
...
class Provider(pulumi.ProviderResource):
    ...
    pulumi_type = "pulumi:providers:tailscale"
    ...
    @property
    @pulumi.getter
    def tailnet(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The organization name of the Tailnet in which to perform actions. Can be set via the TAILSCALE_TAILNET environment
        variable. Default is the tailnet that owns API credentials passed to the provider.
        """
