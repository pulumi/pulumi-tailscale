...
def get_devices(name_prefix: Optional[builtins.str] = None,
    ...
    :param builtins.str name_prefix: Filters the device list to elements whose name has the provided prefix
    """
    __args__ = dict()
...
def get_devices_output(name_prefix: Optional[pulumi.Input[Optional[builtins.str]]] = None,
