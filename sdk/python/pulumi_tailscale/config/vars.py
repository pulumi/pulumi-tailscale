...
class _ExportableConfig(types.ModuleType):
    ...
    @_builtins.property
    def identity_token_environment_variable_name(self) -> Optional[str]:
        """
        ...
        """
        return __config__.get('identityTokenEnvironmentVariableName')
    ...
    def user_agent(self) -> str:
        ...
        """
        return __config__.get('userAgent') or 'Pulumi/3.0 (https://www.pulumi.com) pulumi-tailscale/1.0.0-alpha.0+dev'
