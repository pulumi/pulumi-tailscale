...
class DnsSearchPathsArgs:
    def __init__(__self__, *,
                 search_paths: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        The set of arguments for constructing a DnsSearchPaths resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] search_paths: Devices on your network will use these domain suffixes to resolve DNS names.
        """
        pulumi.set(__self__, "search_paths", search_paths)

    @property
    @pulumi.getter(name="searchPaths")
    def search_paths(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @search_paths.setter
    def search_paths(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class _DnsSearchPathsState:
    def __init__(__self__, *,
                 search_paths: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
    ...
    @property
    @pulumi.getter(name="searchPaths")
    def search_paths(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Devices on your network will use these domain suffixes to resolve DNS names.
        """
        return pulumi.get(self, "search_paths")
    ...
    @search_paths.setter
    def search_paths(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "search_paths", value)


@pulumi.type_token("tailscale:index/dnsSearchPaths:DnsSearchPaths")
class DnsSearchPaths(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            search_paths: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'DnsSearchPaths':
        """
    ...
    @property
    @pulumi.getter(name="searchPaths")
    def search_paths(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Devices on your network will use these domain suffixes to resolve DNS names.
        """
        return pulumi.get(self, "search_paths")
