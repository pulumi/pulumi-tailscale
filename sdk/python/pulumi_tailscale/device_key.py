...
class DeviceKeyArgs:
    def __init__(__self__, *,
                 ...
                 key_expiry_disabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a DeviceKey resource.
        :param pulumi.Input[builtins.str] device_id: The device to update the key properties of
        :param pulumi.Input[builtins.bool] key_expiry_disabled: Determines whether or not the device's key will expire. Defaults to `false`.
        """
    ...
    def key_expiry_disabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def key_expiry_disabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DeviceKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            device_id: Optional[pulumi.Input[builtins.str]] = None,
            key_expiry_disabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'DeviceKey':
        """
    ...
    @property
    @pulumi.getter(name="keyExpiryDisabled")
    def key_expiry_disabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Determines whether or not the device's key will expire. Defaults to `false`.
        """
        return pulumi.get(self, "key_expiry_disabled")
